  ...
  return (
    ...
    >
      <div className="mt-[46px] flex w-[62%] flex-col items-center gap-[118px] lg:w-full lg:gap-[118px] md:w-full md:gap-[88px] sm:gap-[59px]">
        <div className="mx-auto flex w-full max-w-[1262px] items-start justify-between gap-5 lg:px-5 md:flex-col md:px-5">
        ...
        <div className="mx-auto h-[0.7px] w-full max-w-[1444px] bg-white-a700 lg:px-5 md:px-5" />
      </div>
    </footer>
  );
}
