...
export default function EventPlanningSection() {
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-[60px] self-stretch px-14 md:px-5 sm:gap-[30px]">
        <Heading
          size="heading5xl"
          as="h1"
          className="w-[50%] text-center text-[60px] font-bold leading-[114.7%] tracking-[-2.40px] text-black-900_02 md:w-full md:text-[52px] sm:text-[46px]"
        >
        ...
        <div className="flex w-[56%] flex-col items-center gap-[58px] md:w-full sm:gap-[29px]">
          <div className="mx-auto flex w-full max-w-[564px] flex-wrap items-center justify-between gap-5 self-stretch px-[62px] md:px-5">
            <Heading size="headinglg" as="h2" className="text-[16px] font-semibold tracking-[-0.64px] text-green-800">
            ...
            <Heading
              size="headinglg"
              as="h3"
              className="mr-10 text-[16px] font-semibold tracking-[-0.64px] text-gray-700_02 md:mr-0"
            >
          ...
          <div className="flex self-stretch rounded-[22px] border border-solid border-gray-300_01 px-3 md:flex-col">
            <div className="flex flex-1 items-center gap-7 px-3 md:self-stretch sm:flex-col">
              <SelectBox
                ...
                className="w-[42%] gap-2.5 !border-b px-3 tracking-[-0.60px] sm:w-full"
              />
              <SelectBox
                size="xs"
                shape="square"
            ...
            <div className="flex w-[34%] items-center justify-center md:w-full">
              ...
              <Button size="lg" shape="circle" className="w-[40px] self-end rounded-[20px] px-3">
