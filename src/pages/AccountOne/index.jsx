...
export default function AccountOnePage() {
  return (
    <>
      <Helmet>
        <title>Account Settings - Manage Your Notifications and Preferences</title>
        <meta
          name="description"
          content="Easily manage your account settings, notifications, and personal preferences on our user-friendly platform. Stay updated with project reminders, special offers, and more."
        />
      </Helmet>
      <div className="flex w-full flex-col items-center gap-[92px] bg-gray-100 lg:gap-[92px] md:gap-[69px] sm:gap-[46px]">
        ...
        <div className="container-4xl mb-1 flex flex-col gap-[490px] lg:gap-[367px] lg:px-5 md:gap-[367px] md:px-5 sm:gap-[245px]">
