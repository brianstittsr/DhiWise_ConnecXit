...
import BillingDetailSection from "./BillingDetailSection";
...
export default function CXTDetailPagePage() {
  return (
    <>
      <Helmet>
        <title>Billing Information & Support - ConnecXit</title>
        <meta
          name="description"
          content="Access detailed billing support for ConnecXit. Manage your credit card information, submit billing inquiries, and resolve disputes efficiently."
        />
      </Helmet>
